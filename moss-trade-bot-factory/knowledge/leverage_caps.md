...
## 当前快照（46 币，2026-06-08 扩展 AAPL/TSM/SPCX）
...
### xyz HIP-3 builder（23 个，USDC 报价；后端 normalize 自动加 `xyz:` 前缀路由）
...
| 30x | XYZ100 |
| 25x | GOLD · SILVER |
| 20x | NVDA · CL · BRENTOIL · **AAPL** |
| 10x | TSLA · INTC · AMD · MU · SNDK · MSTR · CRCL · COIN · META · GOOGL · ORCL · SKHX · CBRS · **TSM** |
| 5x  | **SPCX** |

> 上面两组合计 46 币种，与后端 `internal/domain/symbols.go : assetMaxLeverages` 一对一同步（2026-06-08 加入 AAPL/TSM/SPCX：AAPL 20x、TSM 10x、SPCX 5x，取自 Hyperliquid xyz dex meta）。

## 表外币种

如果用户要求的 symbol 不在上面 46 币内：
