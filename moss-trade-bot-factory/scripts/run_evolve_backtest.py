...
Usage:
    python run_evolve_backtest.py --data data_cache/hyperliquid_BTCUSDC_15m_2025-07-01_304d.csv --params-file params.json --segment-bars 672
    python run_evolve_backtest.py --data data_cache/hyperliquid_BTCUSDC_15m_2025-07-01_304d.csv --evolution-file evolution_schedule.json
"""
...
def main():
    ...
    parser.add_argument("--data", required=True, help="OHLCV CSV path, or a logical data_cache CSV path from the release asset")
    ...
    symbol = infer_replay_symbol_from_path(data_path)
