...
# Live K-line cache lives under the user's data dir, NOT the skill artifact tree.
# skill/production/data_cache/ is reserved for the fixed 148-day backtest dataset.
LIVE_CACHE_DIR = os.path.expanduser("~/.moss-trade-bot/cache")
...
def _fetch_ohlcv(
    ...
    cache_file = os.path.join(LIVE_CACHE_DIR, f"{exchange_id}_{symbol.replace('/', '_')}_{timeframe}_{cache_tag}.csv")
