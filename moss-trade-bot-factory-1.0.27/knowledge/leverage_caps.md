...
### xyz HIP-3 builder（20 个，USDC 报价；后端 normalize 自动加 `xyz:` 前缀路由）
...
| 30x | XYZ100 |
| 25x | GOLD · SILVER |
| 20x | NVDA · CL · BRENTOIL |
| 10x | TSLA · INTC · AMD · MU · SNDK · MSTR · CRCL · COIN · META · GOOGL · ORCL · SKHX · CBRS |

> 上面两组合计 43 币种，与后端 `internal/domain/symbols.go : assetMaxLeverages` 一对一同步（2026-05-18 commit `37d0a5b` 加入 xyz 段）。

## 表外币种

如果用户要求的 symbol 不在上面 43 币内：
