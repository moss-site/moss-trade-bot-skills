...
# Dataset version suffix is optional: newer release packages ship flat names
# (`hyperliquid_BTCUSDC_15m.csv`) while legacy files carry a
# `_<start>_<Ndays>` suffix (`hyperliquid_BTCUSDC_15m_2025-07-01_304d.csv`).
