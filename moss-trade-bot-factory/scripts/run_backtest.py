...
Usage:
    python run_backtest.py --data data_cache/hyperliquid_BTCUSDC_15m_2025-07-01_304d.csv --params '{"trend_weight":0.45,...}'
    python run_backtest.py --data data_cache/hyperliquid_BTCUSDC_15m_2025-07-01_304d.csv --params-file bot_params.json --capital 10000
"""
...
def main():
    ...
    parser.add_argument("--data", required=True, help="Path to OHLCV CSV, or a logical data_cache CSV path from the release asset")
